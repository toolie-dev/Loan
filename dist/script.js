...
/*#__PURE__*/
function () {
  function Popup(selector, time, slide) {
    ...
    value: function showPopup() {
      ...
      if (this.slide.style.display == 'block') {
        ...
        setTimeout(function () {
          ...
          _this.selector.classList.add('animated', 'fadeInUp');
        }, this.time);
      } else {
...
/* harmony import */ var _popup__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../popup */ "./src/js/modules/popup.js");
...
var popup = new _popup__WEBPACK_IMPORTED_MODULE_10__["default"]('.modules__info .hanson', 3000, '.modules');
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.prev.addEventListener('click', function () {
        ...
        if (_this3.slides[0].tagName == 'BUTTON') {
          _this3.container.appendChild(_this3.next);

          _this3.next.classList.remove(_this3.activeClass);

          _this3.slides[_this3.slides.length - 3].classList.add(_this3.activeClass);
